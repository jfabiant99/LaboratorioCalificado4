...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] letra = {"Solicitud de Ingreso", "Solicitud de Matricula", "Solicitud de Compra", "Solicitud de Venta"};
        tipoInput.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, letra));
    }
    ...
    public void callRegister(View view) {
        ...
        String tipo = tipoInput.getSelectedItem().toString();
